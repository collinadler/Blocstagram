...
//determine the positioning of the subviews in layoutSubviews
- (void) layoutSubviews {
    [super layoutSubviews];
    
    //our white frame will encompass the entire toolbar bounds (except for the small change to the y origin
    CGRect whiteFrame = self.bounds;
    //make the white frame slightlight smaller than the full toolbar view
    whiteFrame.origin.y += 10;
    //set the whiteview frame to this new frame we made
    ...
    //create a custom maskLayer for the purple button
...
//these will inform the delegate when the buttons are pressed
